...
export function renderOrderSummary() {
    ...
    cart.forEach((cartItem) => {
        ...
        cartSummaryHTML += `
        <div class="cart-item-container cartItemContainer cart-item-container-${matchingProduct.id}">
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity productQuantity-${matchingProduct.id}">
                  <span>
                  ...
                  <span class="delete-quantity-link link-primary deleteQuantityLink-${matchingProduct.id}"
                  data-product-id="${matchingProduct.id}"
                  >
                    Delete
                  </span>
              ...
              <div class="delivery-options delivery-option-container">
    ...
    function deliveryOptionsHTML(matchingProduct, cartItem) {
        ...
        deliveryOptions.forEach((deliveryOption) => {
            ...
            html +=
                ` 
                <div class="delivery-option deliveryOptions deliveryOption-${deliveryOption.id}-${matchingProduct.id}"
                data-product-id="${matchingProduct.id}"
                data-delivery-option-id="${deliveryOption.id}">
                  <input type="radio" ${isChecked ? 'checked' : ''}
                    class="delivery-option-input deliveryOptionInput-${deliveryOption.id}-${matchingProduct.id}"
